...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactPanorama = {}, global.React));
}(this, (function (exports, require$$1) { 'use strict';
    ...
    function useNetTableKey(name, key) {
        const [value, setValue] = require$$1.useState(() => CustomNetTables.GetTableValue(name, key));
        require$$1.useEffect(() => {
    ...
    function useNetTableValues(name) {
        const [values, setValue] = require$$1.useState(() => CustomNetTables.GetAllTableValues(name).reduce((accumulator, pair) => (Object.assign(Object.assign({}, accumulator), { [pair.key]: pair.value })), {}));
        require$$1.useEffect(() => {
            const listener = CustomNetTables.SubscribeNetTableListener(name, (_, eventKey, eventValue) => {
    ...
    var C__Users_nyx_dev_odota_reactPanorama_node_modules_objectInspect = function inspect_(obj, options, depth, seen) {
        var opts = options || {};
    ...
    const inspect = (value) => C__Users_nyx_dev_odota_reactPanorama_node_modules_objectInspect(transformValueForFormat(value));
    ...
    global$1.console = console$1;

    const intervals = new Map();
    let nextIntervalId = -100000;
    const setTimeout$1 = (callback, timeout = 0, ...args) => $.Schedule(timeout / 1000, () => callback(...args));
    ...
    // eslint-disable-next-line no-new-func
    const global$2 = new Function('return this')();
    global$2.setInterval = setInterval;
    global$2.clearInterval = clearTimer;
    global$2.setTimeout = setTimeout$1;
    global$2.clearTimeout = clearTimer;
    global$2.setImmediate = setImmediate;
    global$2.clearImmediate = clearTimer;
    ...
    */
    ...
    var C__Users_nyx_dev_odota_reactPanorama_node_modules_objectAssign = shouldUseNative() ? Object.assign : function (target, source) {
    	var from;
    ...
    var C__Users_nyx_dev_odota_reactPanorama_node_modules_scheduler = createCommonjsModule(function (module) {
    ...
    var _assign = C__Users_nyx_dev_odota_reactPanorama_node_modules_objectAssign;
    var React = require$$1__default['default'];
    var checkPropTypes = checkPropTypes_1;
    var Scheduler = C__Users_nyx_dev_odota_reactPanorama_node_modules_scheduler;
    ...
    exports.useNetTableKey = useNetTableKey;
    exports.useNetTableValues = useNetTableValues;
    exports.useRegisterForUnhandledEvent = useRegisterForUnhandledEvent;
